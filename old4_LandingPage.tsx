      ...
      <nav className={`nav ${scrolled ? 'nav--scrolled' : ''}`}>
        <div className="nav__inner">
          ...
          <ul className="nav__links">
            <li><button onClick={() => scrollTo('services')}>Servi├ºos</button></li>
      ...
      {mobileMenu && (
        <div className="mobile-overlay" onClick={() => setMobileMenu(false)}>
          <div className="mobile-overlay__content" onClick={(e) => e.stopPropagation()}>
            ...
            <button onClick={() => scrollTo('services')}>Servi├ºos</button>
      ...
      <section className="hero hero--photo">
        ...
        <div className="hero__inner">
          <div className="hero__content">
            <div className="hero__badge">Consultoria Estrat├®gica</div>
            <h1 className="hero__title">
              Transforme seu neg├│cio com <span className="gold-text">estrat├®gia e intelig├¬ncia</span>
            </h1>
            <p className="hero__desc">
              Na Vertex Consulting, unimos estrat├®gia, marca, intelig├¬ncia artificial
              e treinamentos para levar seu neg├│cio ao pr├│ximo n├¡vel.
            </p>
      ...
      <section id="services" className="section section--photo">
        ...
        <div className="section__inner">
          <div className="section__header anim">
            <h2>Solu├º├Áes completas para o seu crescimento</h2>
          </div>
          <div className="services-grid">
            {[
              { title: 'Estrat├®gia', desc: 'Diagn├│stico de maturidade digital, plano de a├º├úo com metas claras e roadmap de tecnologia para o seu neg├│cio.', icon: Target },
              { title: 'Marca', desc: 'Identidade visual, posicionamento e presen├ºa digital alinhados ao que sua empresa realmente vende.', icon: Diamond },
              { title: 'Intelig├¬ncia Artificial', desc: 'Automa├º├úo de atendimento, CRM com IA e sistemas que aprendem com seus clientes.', icon: Brain },
              { title: 'Treinamentos', desc: 'Capacita├º├úo da sua equipe para operar as ferramentas digitais do dia a dia sem depend├¬ncia t├®cnica.', icon: GraduationCap },
              { title: 'Resultados', desc: 'Acompanhamento de m├®tricas reais: leads gerados, taxas de convers├úo e retorno sobre cada investimento.', icon: BarChart3 },
              { title: 'Presen├ºa Digital', desc: 'Sites, landing pages e sistemas web que convertem visitantes em clientes ÔÇö n├úo s├│ p├íginas bonitas.', icon: Globe },
            ].map((s) => (
              <div key={s.title} className="service-card anim">
                <div className="service-card__icon"><s.icon size={28} /></div>
                <h3>{s.title}</h3>
                <p>{s.desc}</p>
                <span className="service-card__cta">Saiba mais ÔåÆ</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="section__inner about-grid">
          ...
          <div className="about-content anim">
            ...
            <p style={{ color: 'var(--text-muted)', lineHeight: 1.8, fontSize: '0.95rem', marginBottom: 24 }}>
              A Vertex nasceu em Tel├¬maco Borba com um objetivo direto: transformar pequenos neg├│cios locais
              atrav├®s de tecnologia que realmente funciona ÔÇö sem promessa vazia, sem template gen├®rico.
            </p>
            <div className="about-mini-cards">
              <div className="about-mini-card">
                <span className="about-mini-card__icon">Ô£ô</span>
      ...
      <section id="process" className="section section--photo">
        ...
        <div className="section__inner">
          ...
          <div className="process-steps">
            {[
              { n: '01', title: 'Diagn├│stico', desc: 'Entrevista com voc├¬, an├ílise da concorr├¬ncia local e entendimento de como seu cliente te encontra hoje.' },
              { n: '02', title: 'Estrat├®gia', desc: 'Defini├º├úo do que ser├í constru├¡do: site, sistema, CRM ou integra├º├úo. Tudo documentado antes de escrever c├│digo.' },
              { n: '03', title: 'Execu├º├úo', desc: 'Desenvolvimento com tecnologia moderna (Next.js + Supabase) e entregas parciais pra voc├¬ ver o resultado no meio do caminho.' },
              { n: '04', title: 'Resultados', desc: 'Site no ar, m├®tricas sendo coletadas e ajustes finos baseados em dados reais ÔÇö n├úo em suposi├º├úo.' },
            ].map((s) => (
        ...
        <div className="section__inner contact-grid">
          <div className="contact-info anim">
            ...
            <h2>
              ...
              <span className="gold-text">futuro do seu neg├│cio?</span>
            </h2>
            <p>
              Preencha o formul├írio e nossa equipe entrar├í em contato em at├®
              24 horas para agendar uma reuni├úo estrat├®gica.
            </p>
            ...
            <div className="contact-details">
              <div className="contact-detail">
                <div className="contact-detail__label">Localiza├º├úo</div>
                <div className="contact-detail__value">Tel├¬maco Borba, PR</div>
              </div>
              <div className="contact-detail">
                <div className="contact-detail__label">Hor├írio</div>
                <div className="contact-detail__value">Seg - Sex, 8h ├ás 18h</div>
              </div>
              <a
      ...
      {formOpen && (
        <div className="form-modal-backdrop" onClick={closeForm}>
          <div
            ...
            role="dialog"
            aria-modal="true"
            aria-label="Formul├írio de contato"
          >
            ...
            {formStatus === 'success' ? (
              <div className="form-modal__success">
                <div className="form-modal__success-icon">Ô£ô</div>
                <h3>Mensagem enviada!</h3>
                <p>
                  Nossa equipe entrar├í em contato o mais breve poss├¡vel.
                </p>
              ...
              <>
                <div className="form-modal__header">
                  ...
                  <p>
                    Preencha seus dados e nossa equipe entrar├í em contato
                    em at├® 24 horas.
                  </p>
                </div>
                <form ref={formRef} className="contact-form" onSubmit={handleSubmit}>
                  ...
                  <div className="form-row">
                    <div className="form-group">
                      <label htmlFor="has_site">J├í possui site?</label>
                      <select
                        id="has_site"
                        name="has_site"
                  ...
                  <div className="form-group">
                    <label htmlFor="service">Servi├ºo de Interesse</label>
                    <select
                      id="service"
                      name="service"
                      required
                    ...
                    >
                      <option value="" disabled>Selecione um servi├ºo</option>
                      <option value="estrategia">Estrat├®gia</option>
                      <option value="marca">Marca</option>
                      <option value="ia">Intelig├¬ncia Artificial</option>
                      <option value="treinamentos">Treinamentos</option>
                      <option value="presenca-digital">Presen├ºa Digital</option>
      ...
      <footer className="footer">
        <div className="footer__inner">
          <div className="footer__brand">
            ...
            <p>
              Transformando neg├│cios com estrat├®gia, marca, intelig├¬ncia
              artificial e resultados mensur├íveis.
            </p>
          </div>
          <div className="footer__col">
            <h4>Servi├ºos</h4>
            <ul>
              <li><button onClick={() => scrollTo('services')}>Estrat├®gia</button></li>
          ...
          <div className="footer__col">
            <h4>Empresa</h4>
            <ul>
              <li><button onClick={() => scrollTo('about')}>Sobre N├│s</button></li>
              <li><button onClick={() => scrollTo('process')}>Processo</button></li>
